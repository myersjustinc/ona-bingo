...
config.wordList = [
  ...
  { word: 'Chat bot' },
  { word: 'Comments' },
  { word: 'Community', withHyphens: [ 'Com', 'mun', 'i', 'ty' ]},
  { word: 'Digital strategy' },
  { word: 'Distributed content' },
  ...
  { word: 'Freelance', withHyphens: [ 'Free', 'lance' ]},
  ...
  { word: 'Reported.ly' },
  { word: 'Snapchat' },
  { word: 'Socializing', withHyphens: [ 'So', 'cial', 'iz', 'ing' ]},
  { word: 'Trump' },
  { word: 'Verification', withHyphens: [ 'Ve', 'ri', 'fi', 'ca', 'tion' ]},
  { word: 'Vertical' },
