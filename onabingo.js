...
config.wordList = [
  ...
  { word: 'Dreamweaver', withHyphens: [ 'Dream', 'weav', 'er' ]},
  { word: 'Early adopter', withHyphens: [ 'Early ad', 'op', 'ter' ]},
  { word: 'Ecosystem', withHyphens: [ 'E', 'co', 'sys', 'tem' ]},
  { word: 'Embeddable', withHyphens: [ 'Em', 'bed', 'da', 'ble' ]},
  { word: 'Empower', withHyphens: [ 'Em', 'pow', 'er' ]},
  ...
  { word: 'Infographics', withHyphens: [ 'In', 'fo', 'gra', 'phics' ]},
  { word: 'Information', withHyphens: [ 'In', 'for', 'ma', 'tion' ]},
  ...
  { word: 'On a budget' },
  { word: 'Public radio' },
  { word: 'Snapchat', withHyphens: [ 'Snap', 'chat' ]},
  { word: 'Social' },
